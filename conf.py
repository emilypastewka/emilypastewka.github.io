...
BLOG_AUTHOR = "Emily W. Bailey"  # (translatable)
BLOG_TITLE = "The Age of Data"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://emilypastewka.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://emilypastewka.com/"
BLOG_EMAIL = "emilyweymouthbailey@gmail.com"
BLOG_DESCRIPTION = "A lot to learn, a little to share."  # (translatable)
...
THEME_COLOR = '#BBCCEE'  # TODO the default theme thing is indeed happening
